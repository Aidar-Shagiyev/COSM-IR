...
DAMAGED_ATOMS = {x.format(y) for x in DAMAGED_ATOM_NAMES.values() for y in "ATGC"}
...
class Nucleotide:
    ...
    def apply_damage(cls, nucleotides):
        ...
        for nucl in nucleotides:
            ...
            nucl.atoms.current.resn = DAMAGED_ATOM_NAMES[nucl.damage].format(
                nucl.letter
            )
        # TODO: N-PT-N
